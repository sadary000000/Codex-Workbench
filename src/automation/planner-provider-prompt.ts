...
export function buildPlannerProviderPrompt(input: PlannerProviderPromptInput): string {
  ...
  return [
    ...
    "When the Requirement specifies verificationClass, verificationPlan, expectedArtifacts, exact output text, hashes, counts, or ordering, preserve them exactly in the applicable step.",
