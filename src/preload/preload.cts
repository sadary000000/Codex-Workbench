...
contextBridge.exposeInMainWorld("codexWorkbenchV1", Object.freeze({
  ...
  startTurn: (prompt: string, nativeThreadId?: string | null) => ipcRenderer.invoke(channels.turn, String(prompt ?? "").slice(0, 32_768), nativeThreadId ? String(nativeThreadId).slice(0, 256) : null),
