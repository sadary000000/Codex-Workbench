...
当前范围是 Phase 0 + Phase 1：证明 Codex App Server Native Thread 垂直链路。当前不包含正式导航、完整 Thread Workspace、Map、Workflow、Review、Prompt 工具、Git 工作台或 Legacy Conversation 迁移。
