...
当前范围是 Phase 0 + Phase 1 + Phase 2 + Phase 3：证明 Codex App Server Native Thread 垂直链路，建立 Native identity、Project/ThreadProjection、Standalone Thread、Prompt Recovery、restart/reliability 基础，并提供围绕真实 Native Thread 的 Codex-shaped 左侧导航。当前不包含完整 Thread Workspace、Map、Workflow、Review、Prompt 工具、Git 工作台或 Legacy Conversation 迁移。
...
Phase 3 交付记录见 [docs/PHASE-03-CODEX-SHAPED-LEFT-NAVIGATION.md](<D:/办公/AI/Codex_Workbench_V1/docs/PHASE-03-CODEX-SHAPED-LEFT-NAVIGATION.md>)。
