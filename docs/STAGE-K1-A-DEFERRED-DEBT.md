# STAGE-K1-A Deferred Debt

The following items are intentionally outside this stage:

- GPT Planner/provider integration, planner prompt, response normalizer, and full semantic validator.
- Dependency-cycle validation, blocking/non-blocking interpretation, and acceptance-criteria quality.
- JIT detail-stage policy and Planner continuation.
